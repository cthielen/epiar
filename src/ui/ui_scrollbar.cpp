		...
		maxpos( maxpos )
{
	...
	bitmaps[0] = Image::Get("data/skin/ui_scrollbar_bg.png");

	// These are the Up and down Arrows
	bitmaps[1] = Image::Get("data/skin/ui_scrollbar_up.png");
	bitmaps[2] = Image::Get("data/skin/ui_scrollbar_down.png");

	// These Describe the the Marker / Handle
	bitmaps[3] = Image::Get("data/skin/ui_scrollbar_handle_up.png");
	bitmaps[4] = Image::Get("data/skin/ui_scrollbar_handle_bg.png");
	bitmaps[5] = Image::Get("data/skin/ui_scrollbar_handle_down.png");
