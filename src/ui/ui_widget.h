...
#define WIDGET_NAVMAP              (0x00000100) ///< Mask for Nav Map
#define WIDGET_PARAGRAPH           (0x00000200) ///< Mask for Paragraph
#define WIDGET_TEXTAREA            (0x00000400) ///< Mask for Textarea
